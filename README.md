...
TOSCA Data pipeline to generate thumbnail of images in S3 bucket using Amazon lambda function. Push thumbnail to S3 bucket[Reference](https://github.com/radon-h2020/demo-lambda-thumbgen-tosca-datapipeline). Validating the pipeines using Apache Jmeter and collecting metrices.
